...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/domains/full.lst -->12.31 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/domains/full-sld.lst -->9.15 MB<!-- SIZE_END -->
      </td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/ipsets/cdn.lst -->175.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/ipsets/full.lst -->926.2 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/ipsets/full-and-cdn.lst -->581.8 KB<!-- SIZE_END -->
      </td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.json -->19.13 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.srs -->3.92 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.json -->14.63 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.srs -->3.07 MB<!-- SIZE_END -->
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.json -->952.4 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/whitelist/domains.lst -->16.1 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/whitelist/ipset.lst -->1.81 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/whitelist/cidr.lst -->488.9 KB<!-- SIZE_END -->
      </td>
...
### 🩹 Что такое "Crutch" (Костыль)?

Стандартные hosts-файлы содержат секцию `# Crutch` рядом с `# Geoblock`:
* **`# Geoblock`**: Направляет заблокированные домены на публичный SNI-прокси. Весь трафик идет через прокси-сервер.
* **`# Crutch`**: Сопоставляет определенные домены с их **прямыми/оригинальными IP-адресами** в обход прокси. Это используется как временное решение («костыль») по двум причинам:
  1. **Альтернативный SNI-прокси**: Некоторые сервисы/IP-адреса работают как SNI-прокси только для своих собственных доменов.
  2. **Обход локальной блокировки**: Некоторые домены из списка геоблокировок заблокированы в России на уровне DNS/доменов, но их реальные IP-адреса не находятся в черных списках РКН, что позволяет подключаться к ним напрямую без участия прокси.

Файлы с суффиксом `-no-crutch.hosts` полностью исключают эту секцию и направляют все домены исключительно через SNI-прокси.
