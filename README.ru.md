...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/domains/full.lst -->30.54 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/domains/full-sld.lst -->20.91 MB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td><b>IP-сети</b></td>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist/ipsets/full-and-cdn.lst -->595.2 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/ipsets/cdn.lst -->179.2 KB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.json -->48.55 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.srs -->9.84 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.json -->34.31 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.srs -->7.18 MB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td><b>IP-сети</b></td>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.json -->994.5 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.srs -->133.7 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/cdn.json -->302.2 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.yaml -->40.16 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.mrs -->9.31 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full-sld.yaml -->28.22 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full-sld.mrs -->6.60 MB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td><b>IP-сети</b></td>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full-and-cdn.yaml -->813.0 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full-and-cdn.mrs -->169.1 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/cdn.yaml -->246.3 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/service/direct-with-ech.lst -->246.4 KB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td><b>sing-box</b></td>
      ...
      <td>
        ...
        • <!-- SIZE:lists/service-sing-box/direct-with-ech.json -->422.1 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/service-sing-box/direct-with-ech.srs -->106.7 KB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td><b>Mihomo</b></td>
      ...
      <td>
        ...
        • <!-- SIZE:lists/service-mihomo/direct-with-ech.yaml -->342.2 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/service-mihomo/direct-with-ech.mrs -->105.8 KB<!-- SIZE_END -->
      </td>
    </tr>
  </tbody>
</table>
...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.hosts -->683.6 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.hosts -->680.9 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2057/2057<br>
        • 2057/2057
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.adguard.txt -->225.7 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.adguard.txt -->219.6 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2057/2057<br>
        • 2057/2057
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/geohide.adguard.txt -->61.8 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/geohide-no-crutch.adguard.txt -->55.8 KB<!-- SIZE_END -->
      </td>
      <td>
        • 1008/2057<br>
        • 1008/2057
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/comss.adguard.txt -->22.0 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/comss-no-crutch.adguard.txt -->15.9 KB<!-- SIZE_END -->
      </td>
      <td>
        • 284/2057<br>
        • 284/2057
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/mafioznik.adguard.txt -->15.1 KB<!-- SIZE_END --><br>
