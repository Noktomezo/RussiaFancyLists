...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/domains/full.lst -->30.01 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/domains/full-sld.lst -->20.71 MB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td><b>IP-сети</b></td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.json -->47.75 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.srs -->9.67 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.json -->33.98 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.json -->990.7 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.yaml -->39.48 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.mrs -->9.14 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full-sld.yaml -->27.95 MB<!-- SIZE_END --><br>
...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.hosts -->137.0 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.hosts -->134.3 KB<!-- SIZE_END -->
      </td>
      <td>
        • 899/2057 (43.7%)<br>
        • 899/2057 (43.7%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.hosts -->725.0 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.hosts -->722.3 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2057/2057 (100.0%)<br>
        • 2057/2057 (100.0%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.adguard.txt -->332.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.adguard.txt -->326.9 KB<!-- SIZE_END -->
      </td>
      <td>
        • 899/2057 (43.7%)<br>
        • 899/2057 (43.7%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.adguard.txt -->1.71 MB<!-- SIZE_END --><br>
