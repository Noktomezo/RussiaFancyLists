...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock/full.lst -->34.5 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-sing-box/full.json -->56.7 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-mihomo/full.yaml -->46.6 KB<!-- SIZE_END --><br>
...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.hosts -->99.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.hosts -->97.1 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2056/2056<br>
        • 2056/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.hosts -->59.0 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.hosts -->56.2 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2056/2056<br>
        • 2056/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/xbox-dns.hosts -->7.0 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/dns-ai.hosts -->3.8 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/dns-ai-no-crutch.hosts -->1022 B<!-- SIZE_END -->
      </td>
      <td>
        • 36/2056<br>
        • 36/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/xyz.hosts -->11.1 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/malw.hosts -->10.3 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/malw-no-crutch.hosts -->7.5 KB<!-- SIZE_END -->
      </td>
      <td>
        • 332/2056<br>
        • 332/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/mafioznik.hosts -->29.3 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/mafioznik-no-crutch.hosts -->26.5 KB<!-- SIZE_END -->
      </td>
      <td>
        • 1080/2056<br>
        • 1080/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.adguard.txt -->221.4 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.adguard.txt -->215.1 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2056/2056<br>
        • 2056/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.adguard.txt -->117.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.adguard.txt -->111.6 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2056/2056<br>
        • 2056/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/xbox-dns.adguard.txt -->17.6 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/dns-ai.adguard.txt -->8.4 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/dns-ai-no-crutch.adguard.txt -->2.2 KB<!-- SIZE_END -->
      </td>
      <td>
        • 36/2056<br>
        • 36/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/xyz.adguard.txt -->27.8 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/malw.adguard.txt -->24.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/malw-no-crutch.adguard.txt -->18.7 KB<!-- SIZE_END -->
      </td>
      <td>
        • 332/2056<br>
        • 332/2056
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/mafioznik.adguard.txt -->65.4 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/mafioznik-no-crutch.adguard.txt -->59.2 KB<!-- SIZE_END -->
      </td>
      <td>
        • 1080/2056<br>
        • 1080/2056
