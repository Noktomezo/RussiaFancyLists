...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-sing-box/full.json -->56.9 KB<!-- SIZE_END --><br>
...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.hosts -->105.4 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.hosts -->102.7 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2060/2060<br>
        • 2060/2060
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.hosts -->926.2 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.hosts -->923.5 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2060/2060<br>
        • 2060/2060
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.adguard.txt -->229.1 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.adguard.txt -->223.1 KB<!-- SIZE_END -->
      </td>
      <td>
        • 2060/2060<br>
        • 2060/2060
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.adguard.txt -->2.18 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.adguard.txt -->2.18 MB<!-- SIZE_END -->
      </td>
      <td>
        • 2060/2060<br>
        • 2060/2060
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/xbox-dns.adguard.txt -->17.3 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/xyz.adguard.txt -->27.4 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/malw.adguard.txt -->26.4 KB<!-- SIZE_END --><br>
