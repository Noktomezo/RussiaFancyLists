  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist/domains/full-sld.lst -->21.81 MB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td><b>IP-сети</b></td>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/ipsets/full.lst -->968.4 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/ipsets/full-and-cdn.lst -->625.6 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.json -->35.02 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.json -->1021.4 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.srs -->132.8 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.yaml -->40.78 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.mrs -->9.08 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full-sld.yaml -->29.02 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full-and-cdn.yaml -->841.4 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock/full.lst -->35.0 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-sing-box/full.json -->57.5 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-mihomo/full.yaml -->47.2 KB<!-- SIZE_END --><br>
...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.hosts -->21.0 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.hosts -->18.7 KB<!-- SIZE_END -->
      </td>
      <td>
        • 293/2080 (14.1%)<br>
        • 293/2080 (14.1%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.hosts -->1.05 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.hosts -->1.05 MB<!-- SIZE_END -->
      </td>
      <td>
        • 2080/2080 (100.0%)<br>
        • 2080/2080 (100.0%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/geohide.hosts -->23.0 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/malw.hosts -->6.9 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/mafioznik.hosts -->6.4 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/only-crutch.hosts -->2.4 KB<!-- SIZE_END -->
      </td>
      <td>
        • —
      </td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/smart.adguard.txt -->39.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/smart-no-crutch.adguard.txt -->35.2 KB<!-- SIZE_END -->
      </td>
      <td>
        • 293/2080 (14.1%)<br>
        • 293/2080 (14.1%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/combined.adguard.txt -->2.55 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/combined-no-crutch.adguard.txt -->2.54 MB<!-- SIZE_END -->
      </td>
      <td>
        • 2080/2080 (100.0%)<br>
        • 2080/2080 (100.0%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/geohide.adguard.txt -->58.5 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/geohide-no-crutch.adguard.txt -->53.7 KB<!-- SIZE_END -->
      </td>
      <td>
        • 953/2080 (45.8%)<br>
        • 953/2080 (45.8%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/malw.adguard.txt -->15.3 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/hosts/malw-no-crutch.adguard.txt -->10.6 KB<!-- SIZE_END -->
      </td>
      <td>
        • 179/2080 (8.6%)<br>
        • 179/2080 (8.6%)
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/hosts/mafioznik.adguard.txt -->14.0 KB<!-- SIZE_END --><br>
