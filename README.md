...
Generated artifacts are split by format:
- `lists/plain/...` for text lists.
- `lists/sing-box/...` for sing-box rule-sets, with matching `.json` and `.srs` files stored side by side.
- `lists/hosts/...` for hosts-format outputs.
