...
| **Sing-Box** | `lists/sing-box/` | **Domains:**<br>• [`full.json`](./lists/sing-box/domains/full.json)<br>• [`full.srs`](./lists/sing-box/domains/full.srs)<br>**SLD Domains:**<br>• [`full-sld.json`](./lists/sing-box/domains/full-sld.json)<br>• [`full-sld.srs`](./lists/sing-box/domains/full-sld.srs)<br>**IPs:**<br>• [`full.json`](./lists/sing-box/ipsets/full.json)<br>• [`full.srs`](./lists/sing-box/ipsets/full.srs)<br>**IPs + CDN:**<br>• [`full-and-cdn.json`](./lists/sing-box/ipsets/full-and-cdn.json)<br>• [`full-and-cdn.srs`](./lists/sing-box/ipsets/full-and-cdn.srs) | Optimized rulesets (domains and IPSets) for seamless rule-based routing in `sing-box` (JSON and compiled binary `.srs` side-by-side). |
