...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/domains/full.lst -->26.73 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist/ipsets/full.lst -->920.6 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/ipsets/full-and-cdn.lst -->572.2 KB<!-- SIZE_END -->
      </td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.json -->42.81 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.srs -->8.64 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.json -->31.42 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.yaml -->35.30 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.mrs -->8.14 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full-sld.yaml -->25.84 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full.srs -->176.4 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.json -->958.5 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full.mrs -->201.1 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full-and-cdn.yaml -->782.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full-and-cdn.mrs -->158.9 KB<!-- SIZE_END --><br>
