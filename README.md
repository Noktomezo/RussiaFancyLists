...
<table width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/ipsets/full.lst -->934.1 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/ipsets/full-and-cdn.lst -->577.7 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock/ipsets/full.lst -->22.9 KB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td rowspan="2"><b>sing-box</b></td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-sing-box/ipsets/full.json -->38.0 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-mihomo/ipsets/full.yaml -->31.1 KB<!-- SIZE_END --><br>
