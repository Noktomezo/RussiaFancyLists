...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/domains/full.lst -->27.53 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist/ipsets/full.lst -->893.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist/ipsets/full-and-cdn.lst -->565.7 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.json -->44.04 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full.srs -->8.87 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/domains/full-sld.json -->32.13 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.json -->945.3 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/full-and-cdn.srs -->125.8 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-sing-box/ipsets/cdn.json -->296.6 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.yaml -->36.33 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full.mrs -->8.37 MB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/domains/full-sld.yaml -->26.42 MB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        ...
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full-and-cdn.yaml -->772.7 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/blacklist-mihomo/ipsets/full-and-cdn.mrs -->159.2 KB<!-- SIZE_END --><br>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock/ipsets/full.lst -->27.1 KB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td rowspan="2"><b>sing-box</b></td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-sing-box/ipsets/full.json -->44.9 KB<!-- SIZE_END --><br>
        • <!-- SIZE:lists/geoblock-sing-box/ipsets/full.srs -->4.4 KB<!-- SIZE_END -->
      </td>
    </tr>
    <tr>
      <td rowspan="2"><b>Mihomo</b></td>
    ...
    <tr>
      ...
      <td>
        • <!-- SIZE:lists/geoblock-mihomo/ipsets/full.yaml -->36.7 KB<!-- SIZE_END --><br>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><!-- SIZE:lists/hosts/combined-no-crutch.hosts -->221.8 KB<!-- SIZE_END --></td>
    ...
    <tr>
      ...
      <td><!-- SIZE:lists/hosts/only-crutch.hosts -->7.3 KB<!-- SIZE_END --></td>
    ...
    <tr>
      ...
      <td><!-- SIZE:lists/hosts/geohide.hosts -->39.1 KB<!-- SIZE_END --> / <!-- SIZE:lists/hosts/geohide-no-crutch.hosts -->31.9 KB<!-- SIZE_END --></td>
    ...
    <tr>
      ...
      <td><!-- SIZE:lists/hosts/malw.hosts -->39.1 KB<!-- SIZE_END --> / <!-- SIZE:lists/hosts/malw-no-crutch.hosts -->31.9 KB<!-- SIZE_END --></td>
    ...
    <tr>
      ...
      <td><!-- SIZE:lists/hosts/stressozz.hosts -->39.3 KB<!-- SIZE_END --> / <!-- SIZE:lists/hosts/stressozz-no-crutch.hosts -->32.1 KB<!-- SIZE_END --></td>
