...
| **Sing-Box** | `lists/sing-box/` | **Domains:** [`full.json`](./lists/sing-box/domains/full.json)<br>[`.srs`](./lists/sing-box/domains/full.srs)<br>**SLD Domains:** [`full-sld.json`](./lists/sing-box/domains/full-sld.json)<br>[`.srs`](./lists/sing-box/domains/full-sld.srs)<br>**IPs:** [`full.json`](./lists/sing-box/ipsets/full.json)<br>[`.srs`](./lists/sing-box/ipsets/full.srs)<br>**IPs + CDN:** [`full-and-cdn.json`](./lists/sing-box/ipsets/full-and-cdn.json)<br>[`.srs`](./lists/sing-box/ipsets/full-and-cdn.srs) | Optimized rulesets (domains and IPSets) for seamless rule-based routing in `sing-box` (JSON and compiled binary `.srs` side-by-side). |
